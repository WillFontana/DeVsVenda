...
void realizaCompra(struct compra *compra, int produtosNaCompra)
{
	...
	printf("Foram vendidos %d unidades do produto %s no valor de %0.2lf", compra->qtVenda1, compra->produtosAComprar.mercadoria1->nomeProduto, compra->subTotalProduto1);
	if (produtosNaCompra == 2)
	{
